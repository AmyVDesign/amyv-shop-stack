 ...
 * remote, ported fresh for the staff's clamp mounting (own copy: see the
 * top-level note on why the two products don't share code yet). Unlike
 * the whip's inline remote, this pod has no cable pass-through connector
 * on its upper end, it clamps flat against the bracket tube there.
 */
export default function RemotePod({ position, rotationY }: RemotePodProps) {
