...
const ANIMATED_PATTERNS: ReadonlySet<StaffPattern> = new Set([
  "rainbow",
  "comet",
  "pulse",
  "galaxy",
 ...
 * copy of the whip's instancing builder, patterns are painted by a
 * *global* t (position across the whole staff height), not local-to-
 * section t, so "mirror" reads symmetric from the grip outward and the
 * other patterns flow continuously bottom to top.
 */
