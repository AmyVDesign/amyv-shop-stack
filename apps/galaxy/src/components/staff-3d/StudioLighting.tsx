...
/** Ambient fill + a cool rim light + a warm key point light, fixed in world space. Intensities lift for the "off" unlit product shot. Own copy of the whip's lighting, staff-specific positions/distance. */
